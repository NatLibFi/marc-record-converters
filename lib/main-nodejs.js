...
(function(root, factory) {
    ...
    if (typeof define === 'function' && define.amd) {
        define(['./adapters/nodejs', 'aleph-sequential', 'marcxml', 'iso2709'], factory);
    } else if (typeof module === 'object' && module.exports) {
        module.exports = factory(require('./adapters/nodejs'), require('aleph-sequential'), require('marcxml'), require('iso2709'));
    }
