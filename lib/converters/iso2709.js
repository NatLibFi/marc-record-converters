...
function factory(MarcRecord, xmldom)
{
   ...
   */
  function utf8_substr(str, start_in_bytes, length_in_bytes)
  {
    ...
    function convertRecord(record_str)
    {
      ...
      function processDirectoryEntry(entry)
      {
        ...
        if (tag.substring(0, 2) == '00') {
          ...
          data_element_str = utf8_substr(data_field_str, parseInt(start_char_pos, 10), parseInt(field_length, 10));
